...
public class MapsActivity extends FragmentActivity implements
    ...
    private double fromLongitude ;//= 79.822582
    private double fromLatitude  ;//= 11.928275

    //To -> the second coordinate to where we need to calculate the distance
    private double toLongitude = 80.261408;
    private double toLatitude  = 12.985214;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonsetPoint = (Button) findViewById(R.id.setPoint);
        buttonsetPoint.setOnClickListener(this);
    }
    //----------------------------------------------------
    ...
    public void ongo(View v)
    {
        ...
        Intent i = new Intent(getApplicationContext(),PathGoogleMapActivity.class);
        startActivity(i);
    ...
    private PolyLineListener mPolyLineListener = new PolyLineListener() {
        ...
        public void whenDone(PolylineOptions output) {
            mMap.clear();
            mPolyline = mMap.addPolyline(output);
            ...
            mMarker = mMap.addMarker(new MarkerOptions().position(src)
        ...
        public void whenFail(String status) {
            ...
            switch (status) {
                case "NOT_FOUND":
                    ...
                    Toast.makeText(getApplicationContext(), "No road map available...", Toast.LENGTH_SHORT).show();
                    break;
                case "ZERO_RESULTS":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "No road map available...", Toast.LENGTH_SHORT).show();
                ...
                case "MAX_WAYPOINTS_EXCEEDED":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "Way point limit exceeded...", Toast.LENGTH_SHORT).show();
                    break;
                case "MAX_ROUTE_LENGTH_EXCEEDED":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "Road map limit exceeded...", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case "OVER_DAILY_LIMIT":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "MayBe invalid API/Billing pending/Method Depricated...", Toast.LENGTH_SHORT).show();
                    break;
                case "OVER_QUERY_LIMIT":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "Too many request, limit exceeded...", Toast.LENGTH_SHORT).show();
                    break;
                case "REQUEST_DENIED":
                    System.out.println("RRR status = " + status);
                    Toast.makeText(getApplicationContext(), "Directions service not enabled...", Toast.LENGTH_SHORT).show();
                    break;
                case "UNKNOWN_ERROR":
                    System.out.println("RRR status = " + status);
    ...
    public void drawPath(String  result) {
        ...
        Double fin = distance / 1000;

        int speedIs1KmMinute = 100;
        float estimatedDriveTimeInMinutes = (float) (fin / speedIs1KmMinute);

        float last = estimatedDriveTimeInMinutes / 60000;

        //Displaying the distance
        Toast.makeText(this,String.valueOf( "Kilometers "+ fin  +"\n Estimated Time" + last +" minutes"),Toast.LENGTH_SHORT).show();
